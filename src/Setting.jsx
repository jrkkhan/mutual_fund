              ...
              <div className="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                  <div className="text-gray-600">
                    <img alt="whar" src="https://www.hayalanka.com/wp-content/uploads/2017/07/avtar-image.jpg" className="lg:w-4/6 md:mx-0 mx-auto w-3/6 md:rounded-none rounded-full  lg:mb-0 mb-6" />
